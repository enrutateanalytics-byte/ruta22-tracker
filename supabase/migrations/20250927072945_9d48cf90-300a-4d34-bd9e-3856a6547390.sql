-- Limpiar duplicados y reorganizar datos
TRUNCATE public.route_points CASCADE;
...
-- Insertar paradas usando DO block
DO $$
DECLARE
    ruta_m1_id UUID;
    ruta_centro_id UUID;
    ...
    ruta_rio_id UUID;
BEGIN
    -- Obtener IDs de las rutas recién creadas
    ...
    -- Insertar puntos de ruta para M1 R18 basado en coordenadas del KML
